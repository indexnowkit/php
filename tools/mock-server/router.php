...
$n = (int) ($_GET['n'] ?? 1);
switch ($scenario) {
    case 'ok200': $respond(200); break;
    case 'pending202': $respond(202); break;
    case 'bad400': $respond(400, 'bad'); break;
    case 'forbidden403': $respond(403, 'forbidden'); break;
    case 'unprocessable422': $respond(422, 'unprocessable'); break;
    case 'ratelimit429': $respond(429, 'slow down', ['Retry-After' => '2']); break;
    case 'ratelimit429-then-ok': $countForScenario <= $n ? $respond(429, 'slow down', ['Retry-After' => '1']) : $respond(200); break;
    case 'flaky500-then-ok': $countForScenario <= $n ? $respond(503, 'oops') : $respond(200); break;
    case 'timeout': sleep(30); $respond(200); break;
